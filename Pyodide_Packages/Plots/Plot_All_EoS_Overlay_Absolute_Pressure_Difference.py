...
Figure_Basename = "all_eos_overlay_absolute_pressure_difference"
...
# Build the all-EoS overlay figure showing absolute pressure difference and return it
def Create_Figure(Dataset, Config_Module):
    ...
    # Draw each comparison study's absolute pressure-difference curve
    ...
    Plot_Styling.Style_Ax(Ax_Plot, X_Pressure_Label, "Pdiff (GPa)", "")
